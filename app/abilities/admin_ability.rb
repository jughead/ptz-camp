class AdminAbility
  ...
  def camp_rules
    can %i[index badges show new edit create update dashboard], Camp
  end
  ...
  def camp_field_set_rules
    can [:edit, :update], CampFieldSet if user.superadmin?
  end
end
