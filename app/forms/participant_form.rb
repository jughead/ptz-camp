class ParticipantForm
  ...
  PARTICIPANT_METHODS = %i[arrival delegation_id departure passport_scan personal].freeze
  ...
  def participant_params
    @params&.permit(:arrival, :departure, :delegation_id, :passport_scan, personal: PersonalData.attributes) || {}
  end
